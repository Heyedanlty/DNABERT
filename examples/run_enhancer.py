...
MODEL_CLASSES = {
    ...
    "dnaenhancerlong": (BertConfig, BertForEnhancerClassification, DNATokenizer),
    "dnaenhancerlongcat": (BertConfig, BertForEnhancerClassificationCat, DNATokenizer),
}
                    
TOKEN_ID_GROUP = ["bert", "dnalong", "dnalongcat", "xlnet", "albert", "enhancerlong", "enhancerlongcat"] 
