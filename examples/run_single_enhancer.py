...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    processor = processors[task](args.label_offset)
...
def main():
    ...
    parser.add_argument("--label_offset", type=int, default=1, help="Set offset of the label you want to train: e.g. 1 <-> isEnhancer")
    ...
    processor = processors[args.task_name](args.label_offset)
